                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">                                                    <thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        List<Units> rr = new getUnit().getunits();
                                                        for (int i = 0; i < rr.size(); i++) {
                                                    %>
                                                    <td class="idd" style="display: none;"><%=rr.get(i).getUnitId()%> </td>
                                                    <td class="descc"><%=rr.get(i).getUnitDesc()%></td>                                                
                                                    <td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="H1">Del Unit</h4>
                        </div>
                        ...
                        <div class="modal-footer">
                            <form method="POST" action="unit">
                                ...
                                <button type="submit" class="btn btn-primary" name="del_unit" value="delete">DELETE</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="buttonedModal2" tabindex="-1" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true" >
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="H1">Edit Unit</h4>
                        </div>
                        <form role="form" method="POST" action="unit">
                        <div class="modal-body">
                            <input autofocus=""  type="text" class="form-control" name="editevalue" placeholder="enter your unit here"  id="editevalue" required="" />
                            <input type="hidden" name="edit_unit_id" id="edit_unit_id"  />
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default"  name="update_unit" value="update">Update</button>
                        </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal fade" id="formModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="H2">Unit Form</h4>
                        </div>
                        <div class="modal-body">
                            <form role="form" action="unit" method="POST">
                                <div class="form-group">
                                    <label>Unit</label>
                                    <input clas="form-control" type="text" name="unit1" placeholder="enter unit here" required=""/>
                                </div>                                      
                                <div class="modal-footer">
                                    <button type="submit" name="saveunit" value="save" class="btn btn-primary">Save changes</button>
                                </div>
                            </form>
                        </div>                            
                    </div>
